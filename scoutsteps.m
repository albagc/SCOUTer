function [outsteps] = scoutsteps(X, pcamodel, T2_target, SPE_target, nsteps, g)
...
% OUTPUTS
%
% outsteps: struct with output information..
...
for k = 1:nsteps+1
    ...
    a = sqrt(t2steps(1+n*(k-1):n*(k)) ./ T2_X) - 1;
